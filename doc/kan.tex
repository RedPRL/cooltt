...
\begin{notation}
  ...
  \[
    \begin{array}{l}
      ...
      \IsContr{\Code{C}} \coloneq \CodeSum{x:\Code{C}}{\CodeProd{y:\Code{C}}{\CodePath{\lambda\Dummy.\Code{C}}{x}{y}}}
    \end{array}
  \]
  \[
    \begin{array}{l}
      \Fiber : \Prod{\Code{A}:\TpUniv}{\Prod{\Code{B}:\TpUniv}{\Prod{F:\TpEl{\Code{A}} \to \TpEl{\Code{B}}}{\Prod{N:\TpEl{\Code{B}}}{\TpUniv}}}}\\
      \Fiber{\Code{A}}{\Code{B}}{F}{N} \coloneq \CodeProd{x:\Code{A}}{\CodePath{\lambda\Dummy.\Code{B}}{F\prn{x}}{N}}
    \end{array}
  \]
  \[
    \begin{array}{l}
      \Equiv : \Prod{\Code{A}:\TpUniv}{\Prod{\Code{B}:\TpUniv}{\TpUniv}}\\
      \Equiv{\Code{A}}{\Code{B}} \coloneq
      \CodeSum{
        f:\Code{A}\mathrel{\hat{\to}}\Code{B}
      }{
        \CodeProd{x:\Code{B}}{
          \IsContr{\Fiber{\Code{A}}{\Code{B}}{\ElOut{f}}{x}}
        }
      }
    \end{array}
  \]
...
\begin{mathparpagebreakable}
  ...
  \inferrule[formal v code]{
    ...
    \Code{B} : \TpUniv\\
    E : \Prod{*:\TpPrf{r=0}}{\TpEl{\Equiv{\Code{A}\prn{*}}{\Code{B}}}}
  }{
