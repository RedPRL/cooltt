...
\NewDocumentCommand\TmEquivApp{gggg}{
  \mathsf{EquivApp}\IfValueT{#1}{\prn{#1;#2;#3;#4}}
}
...
\todo[CJHM]{
  The entire text is out of order now. For example,
  $\ElOut$ and $\CodeEquiv$ are used (in a non-trivial way) before they are introduced!
  It is not the top priority now as we can do Haskell bindings in our mind.
}
...
\begin{mathparpagebreakable}
  ...
  \inferrule[v type introduction]{
    ...
    N : \TpEl{\Code{B}} \mid r=0 \to \TmEquivApp{\Code{A}}{\Code{B}}{E\prn{*}}{M\prn{*}}
  }{
  ...
  \inferrule[v type elimination]{
    ...
    \mid r=0 \to \TmEquivApp{\Code{A}}{\Code{B}}{E\prn{*}}{M}
    \mid r=1 \to M
  }
  \and
  \inferrule[v type computation]{
    ...
    \Hint{N : \TpEl{\Code{B}} \mid r=0 \to \TmEquivApp{\Code{A}}{\Code{B}}{E\prn{*}}{M\prn{*}}}
  }{
...
\begin{notation}
  These are abbreviations for equivalences.
  \[
    \begin{array}{l}
