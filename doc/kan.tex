...
Truth of each $\phi:\COF$ has the expected meaning; in particular, $0=1$ is the
false proposition, and under a hypothesis $\TpPrf{r=s}$ we have $r=s:\DIM$. We
will make particular use of the \emph{boundary} cofibration:
...
%the structure and algorithms of univalent Kan universes of Kan types,
