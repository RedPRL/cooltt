...
\begin{mathparpagebreakable}
  \inferrule{
    ...
    {
      \begin{array}{l}
        \tilde{T} : \Prod{i:\DIM}{\Prod{*:\TpPrf{i=r\lor\phi\lor{s=s'}\lor\psi}}{\TpEl{\Code{A}\prn{s,*}}}}\\
        \tilde{T}\prn{i,*} :=
        \brk{
          i=r\lor\phi \to \tilde{O}\prn{i,*}
          \mid
          s=s'\lor\psi \to \Coe{\lambda j. \Code{A}\prn{j,*}}{s'}{s}{\tilde{P}\prn{i,*}}
        }
      \end{array}
    }
  }{
    ...
    \TmBox{s}{s'}{\psi}{\lambda{*}.\tilde{P}\prn{r',*}}{
      \HCom{\Code{A}\prn{s,*}}{r}{r'}{\phi\lor{s=s'}\lor\psi}{\tilde{T}}
    }
    :
    \TpEl{
      \CodeHCom{s}{s'}{\psi}{\Code{A}}
