...
\NewDocumentCommand\IsContr{g}{
  \mathsf{IsContr}\IfValueT{#1}{\prn{#1}}
}

\NewDocumentCommand\Fiber{gggg}{
  \mathsf{Fiber}\IfValueT{#1}{\prn{#1;#2;#3;#4}}
}

\NewDocumentCommand\Equiv{gg}{
  \mathsf{Equiv}\IfValueT{#1}{\prn{#1;#2}}
}
...
\begin{mathparpagebreakable}
  \inferrule[formal pi code]{
    \Code{A} : \TpUniv\\
    \Code{B} : \Prod{M:\TpEl{\Code{A}}}{\TpUniv}
  }{
    \CodeProd{M:\TpEl{\Code{A}}}{\Code{B}\prn{M}} : \TpUniv
  }
  \and
  \inferrule[formal sigma code]{
    ...
    \CodeSum{M:\TpEl{\Code{A}}}{\Code{B}\prn{M}} : \TpUniv
  }
\end{mathparpagebreakable}
...
\begin{notation}
  ...
  \[
    \begin{array}{l}
      \IsContr : \Prod{\Code{C}:\TpUniv}{\TpUniv}\\
      \IsContr{\Code{C}} \coloneq \CodeProd{M:\TpEl{\Code{C}}}{\CodeProd{N:\TpEl{\Code{C}}}{\CodePath{\lambda\Dummy.\Code{C}}{N}{M}}}
    \end{array}
  \]
  \[
    \begin{array}{l}
      \Fiber : \Prod{\Code{A}:\TpUniv}{\Prod{\Code{B}:\TpUniv}{\Prod{F:\TpEl{\Code{A}} \to \TpEl{\Code{B}}}{\Prod{N:\TpEl{\Code{B}}}{\TpUniv}}}}\\
      \Fiber{\Code{A}}{\Code{B}}{F}{N} \coloneq \CodeProd{M:\TpEl{\Code{A}}}{\CodePath{\lambda\Dummy.\Code{B}}{F\prn{M}}{N}}
    \end{array}
  \]
  \[
    \begin{array}{l}
      \Equiv : \Prod{\Code{A}:\TpUniv}{\Prod{\Code{B}:\TpUniv}{\TpUniv}}\\
      \Equiv{\Code{A}}{\Code{B}} \coloneq \CodeSum{F:\TpEl{\Code{A}}\to\TpEl{\Code{B}}}{\CodeProd{N:\TpEl{\Code{B}}}{\IsContr{\Fiber{\Code{A}}{\Code{B}}{F}{N}}}}
    \end{array}
  \]
\end{notation}
...
\begin{mathparpagebreakable}
  ...
  \inferrule[formal v code]{
    ...
    \Code{B} : \TpUniv\\
    E : \Prod{*:\TpPrf{r=0}}{\Equiv{\Code{A}\prn{*}}{\Code{B}}}
  }{
