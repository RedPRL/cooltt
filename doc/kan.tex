  ...
  \inferrule{
    ...
    \\\\\\
    {
      \begin{array}{l}
        ...
        \tilde{O}\prn{j,*} :=
          \HCom{\Code{A}_{r}\prn{s_{r},*}}{s'_{r}}{j}{\phi_{r}}{
            \lambda j,*.
            \brk{
              ??
              \mid
    ...
    \\\\\\
    {
      \begin{array}{l}
        \tilde{Q} : \Prod{j:\DIM}{
          \Prod{*:\TpPrf{j=s_{r'}\lor \phi_{r'}}}{
            \TpEl{\Code{A}_{r'}\prn{j,*}}}}\\
        \tilde{Q}\prn{j,*} :=
          ??
          %\Com{\Code{A}_{r'}}{s_{r'}}{j}{\phi_{r'}}{\lambda k.
          %  \Coe{\Code{A}_{r'}}{s'_{r'}}{k}{
          %    \Coe{\lambda i.\Code{A}_{i}\prn{j,*}}{r}{k}{M}}}
      \end{array}
    }
    \\\\\\
    {
      \begin{array}{l}
        ...
        \tilde{H}\prn{j,*} :=
        \brk{
          j=s_{r'}\lor \phi_{r'} \to \tilde{Q}\prn{j,*}
          \mid
          r=r' \to \tilde{O}\prn{j,*}
        }
      \end{array}
