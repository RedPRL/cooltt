...
\begin{cool}
  ...
  the composition data, inspired by the the cubical type theoretic
...
%
  ...
  special treatment of \textsf{hcomp}, thus needing cubical subtypes. In other
