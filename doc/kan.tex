...
\begin{mathparpagebreakable}
  \inferrule{
    ...
    \Hint{
      ...
      \Prod{i:\DIM}{
        \Prod{j:\DIM}{
          \Prod{*:\TpPrf{j=s\prn{i}\lor{\phi\prn{i}}}}{
            \TpUniv
          }
        }
      }
    ...
    \Hint{
      M : \TpEl{
        \CodeHCom{s\prn{r}}{s'\prn{r}}{\phi\prn{r}}{\Code{A}\prn{r}}
      }
    }
    \\\\\\
    {
      \begin{array}{l}
        \tilde{C} : \TpHCom{s\prn{r'}}{s'\prn{r'}}{\phi\prn{r'}}{\Code{A}\prn{r'}}\\
        \tilde{C} := {?}
      \end{array}
    }
  }{
    \Coe{
      \lambda i.
      \CodeHCom{s\prn{i}}{s'\prn{i}}{\phi\prn{i}}{\Code{A}}
    }{r}{r'}{M}
    =
    \ElIn{\tilde{C}}
    :
