...
\begin{notation}
  ...
  \[
    \begin{array}{l}
      \CodeFiber : \Prod{\Code{A}:\TpUniv}{\Prod{\Code{B}:\TpUniv}{\Prod{F:\TpEl{\Code{A}} \to \TpEl{\Code{B}}}{\Prod{N:\TpEl{\Code{B}}}{\TpUniv}}}}\\
      \CodeFiber{\Code{A}}{\Code{B}}{F}{N} \coloneq \CodeProd{x:\Code{A}}{\CodePath{\lambda\Dummy.\Code{B}}{F\prn{x}}{N}}
    \end{array}
  \]
  \[
    \begin{array}{l}
      ...
      \CodeSum{
        ...
        \CodeProd{x:\Code{B}}{
          \CodeIsContr{\CodeFiber{\Code{A}}{\Code{B}}{\ElOut{f}}{x}}
        }
      }
    \end{array}
  \]
