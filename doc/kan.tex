...
\begin{warning}
  Contractibility is defined in terms of paths \emph{to} the center, not \emph{from} it.
\end{warning}
      ...
      \begin{array}{l}
        ...
        \Prod{*:\TpPrf{s_{r'}=0}}{
          \Prod{
            ...
            \TpPath{
              \lambda\Dummy.\TpEl{\CodeFiber{\Code{A}_{r'}\prn{*}}{\Code{B}_{r'}}{\tilde{F}\prn{r',*}}{\tilde{O}}}
            }{
              \ElIn{\TmPair{\TmFst{p}}{\ElIn{\TmSnd{p}}}}
            }{
              \tilde{P}\prn{*}
            }
          }
      ...
      \begin{array}{l}
        ...
        \Prod{*:\TpPrf{s_{r'}=0\land\prn{\prn{\forall k.s_k=0}\lor r=r'}}}{
          \TpPath{
            ...
            {\color{RedDevil}{\cdots\text{\textit{really too long}}\cdots}}
          }{
            \tilde{P}\prn{*}
          }
        }
        \\
        \tilde{S}\prn{*} \coloneq
        \tilde{Q}\prn{*,\brk{\prn{\forall k.s_k = 0}\to\TmPair{\Coe{\Code{A}_\bullet\prn{*}}{r}{r'}{M}}{\tilde{R}\prn{*}} \delimmid r=r'\to \TmPair{M}{\lambda\Dummy.\TmVproj{s_r}{E_r}{M}}}}
      \end{array}
    }
    \\\\\\
    {
      \begin{array}{l}
        \tilde{T} :
        \Prod{*:\TpPrf{s_{r'}=0}}{
          \CodeFiber{\Code{A}_{r'}\prn{*}}{\Code{B}_{r'}}{E_{r'}\prn{*}}{\tilde{O}}
        }
        \\
        \tilde{T}\prn{*} \coloneq
        \HCom{\CodeFiber{\Code{A}_{r'}\prn{*}}{\Code{B}_{r'}}{E_{r'}\prn{*}}{\tilde{O}}}{1}{0}{\parens{\forall k.s_k = 0}\lor r=r'}{
          \lambda j,*.
          \brk{
            j=1 \to \tilde{P}\prn{*}
            \delimmid
