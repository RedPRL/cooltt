...
\begin{enumerate}
  ...
  $\phi\land\psi$; and
  \item $0=1$ is the false proposition, whose elimination is the empty case
  split $\brk{}$.
\end{enumerate}
...
We extend all the above notations to $n$-ary disjunctions as needed:
