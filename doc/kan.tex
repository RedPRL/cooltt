...
\NewDocumentCommand\TmEquivInvHelper{gggg}{
  \mathsf{EquivInvHelper}\IfValueT{#1}{\prn{#1;#2;#3;#4}}
}
\NewDocumentCommand\TmEquivInv{gggg}{
  \mathsf{EquivInv}\IfValueT{#1}{\prn{#1;#2;#3;#4}}
}
\NewDocumentCommand\TmEquivInvPathTo{gggggg}{
  \mathsf{EquivInv2}\IfValueT{#1}{\prn{#1;#2;#3;#4;#5;#6}}
}
...
\[
  \begin{array}{l}
    \CodeFiber : \Prod{\Code{A}:\TpUniv}{\Prod{\Code{B}:\TpUniv}{\TpEl{\Code{A}\CodeTo\Code{B}}\to\TpEl{\Code{B}}\to\TpUniv}}\\
...
\[
  \inferrule{
    ...
    {
      \begin{array}{l}
        \tilde{P} : \Prod{i:\DIM}{\TpPrf{i=r\lor\phi\lor\partial{s}}\to\TpEl{\Code{B}}}\\
