...
\begin{mathparpagebreakable}
  ...
  \and
  % Favonia: ElOut and Equiv are used here (in a non-trivial way) before they are introduced!
  \inferrule[v type introduction]{
    \Hint{r:\DIM}\\
    \Hint{\Code{A} : \Prod{*:\TpPrf{r=0}}{\TpUniv}}\\
    \Hint{\Code{B} : \TpUniv}\\
    \Hint{E : \Prod{*:\TpPrf{r=0}}{\TpEl{\CodeEquiv{\Code{A}\prn{*}}{\Code{B}}}}}\\
    \\\\
    M : \Prod{*:\TpPrf{r=0}}{\TpEl{\Code{A}\prn{*}}}\\
    N : \TpEl{\Code{B}} \mid r=0 \to \ElOut{\TmFst{\ElOut{E\prn{*}}}}\prn{M\prn{*}}
  }{
  ...
  \inferrule[v type elimination]{
    ...
    \mid r=0 \to \ElOut{\TmFst{\ElOut{E\prn{*}}}}\prn{M}
    \mid r=1 \to M
  }
  \and
  \inferrule[v type computation]{
    ...
    \Hint{N : \TpEl{\Code{B}} \mid r=0 \to \ElOut{\TmFst{\ElOut{E\prn{*}}}}\prn{M\prn{*}}}
  }{
  ...
  \inferrule[v type uniqueness]{
    ...
    M = \TmVin{r}{E}{M}{\TmVproj{r}{E}{M}} : \TpEl{\CodeV{r}{\Code{A}}{\Code{B}}{E}}
  }
  \and
...
\section{Composition in V types}
...
\begin{mathparpagebreakable}
  \inferrule{
    ...
    \\\\\\
    {
      \begin{array}{l}
        ...
        \tilde{P}\prn{i,*} \coloneq \brk{
            ...
            s=0 \to \ElOut{\TmFst{\ElOut{E\prn{*}}}}\prn{O\prn{\Code{A}\prn{*},M,i}} \mid
    ...
    =
    \TmVin{s}{E}{\tilde{O}\prn{\Code{A}\prn{*},M,r'}}{\HCom{\Code{B}}{r}{r'}{\phi\lor\partial{s}}{\tilde{P}}}
    :
    \TpEl{
      \CodeV{s}{\Code{A}}{\Code{B}}{E}
    }
