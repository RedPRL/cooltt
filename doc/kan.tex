...
\begin{mathparpagebreakable}
  ...
  \inferrule[v type introduction]{
    ...
    N : \TpEl{\Code{B}} \mid r=0 \to \ElOut{\TmFst{E\prn{*}}}\prn{M\prn{*}}
  }{
  ...
  \inferrule[v type elimination]{
    ...
    \mid r=0 \to \ElOut{\TmFst{E\prn{*}}}\prn{M}
    \mid r=1 \to M
  }
  \and
  \inferrule[v type computation]{
    ...
    \Hint{N : \TpEl{\Code{B}} \mid r=0 \to \ElOut{\TmFst{E\prn{*}}}\prn{M\prn{*}}}
  }{
...
\begin{mathparpagebreakable}
  \inferrule{
    ...
    \\\\\\
    {
      \begin{array}{l}
        ...
        \tilde{P}\prn{i,*} \coloneq \brk{
            i=r\lor\phi\to\TmVproj{s}{E}{M} \mid
            s=0 \to \ElOut{\TmFst{E\prn{*}}}\prn{O\prn{\Code{A}\prn{*},M,i}} \mid
    ...
    =
    \TmVin{s}{E}{\tilde{O}\prn{\Code{A}\prn{*},M,r'}}{\tilde{P}}
    :
    \TpEl{
      \CodeV{s}{\Code{A}}{\Code{B}}{E}
    }
