...
\begin{mathparpagebreakable}
  \inferrule{
    ...
    {
      \begin{array}{l}
        \tilde{N} : \Prod{k:\DIM}{\Prod{j:\DIM}{
          \Prod{*:\TpPrf{??}}{
            \TpEl{\Code{A}_{r}\prn{??}}}}}\\
        \tilde{N}\prn{k,j} :=
          \Coe{\lambda j.??}{s'_k}{j}{\Coe{\lambda i.??}{r}{k}{M}}
      \end{array}
    }
    \\\\\\
    {
      \begin{array}{l}
        \tilde{O} : \Prod{j:\DIM}{
          \Prod{*:\TpPrf{??}}{
            \TpEl{\Code{A}_{r}\prn{??}}}}\\
        \tilde{O}\prn{j,*} :=
          \HCom{\Code{A}_{r}\prn{??}}{s'_{r}}{j}{\phi_{r}}{
            \dots} \\
            \qquad\qquad
            \lambda j,*.
            \brk{
        ...
        \tilde{P} :=
          \Com{\lambda i.\Code{A}_i\prn{s_i,*}}{r}{r'}{\forall i.\phi_i \lor \forall i.\prn{s_i=s'_i}}{
            ...
            \brk{
              ...
              \mid
              \forall i.(s_i=s'_i) \to \Coe{\lambda i.\Code{A}_i\prn{??}}{r}{i}{M}
            }
      \end{array}
    }
    \\\\\\
