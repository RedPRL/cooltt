  ...
  \inferrule{
      ...
      \begin{array}{l}
        ...
        \Prod{*:\TpPrf{s_{r'}=0}}{
          \Prod{
            ...
            \TpPath{
              \lambda\Dummy.\TpEl{\CodeFiberAlt{*}}
            }{
    ...
    \\\\\\
    {
      \begin{array}{l}
        ...
        \tilde{Q}\prn{
          *,
          \brk{
            \prn{\forall k.s_k = 0}\to\ElIn{\TmPair{\Coe{\Code{A}_\bullet\prn{*}}{r}{r'}{M}}{\ElIn{\tilde{R}\prn{*}}}}
            \delimmid
            r=r'\to \ElIn{\TmPair{M}{\ElIn{\lambda\Dummy.\TmVproj{s_r}{E_r}{M}}}}
          }
        }
      \end{array}
    }
    \\\\\\
    {
      \begin{array}{l}
        ...
        \HCom{
          \CodeFiberAlt{*}
        }{1}{0}{\parens{\forall k.s_k = 0}\lor r=r'}{
          \lambda j,*.
          \brk{
            j=1 \to \tilde{P}\prn{*}
            \delimmid
