...
%token BANG COLON COLON_COLON COLON_EQUALS COLON_COLON_EQUALS HASH PIPE COMMA DOT SEMI LEFT_ARROW RIGHT_ARROW RRIGHT_ARROW UNDERSCORE DIM DDIM COF BOUNDARY
